...
namespace Shopify.Admin.Console.Data
{
    ...
    public partial class newsletter_problem
    {
        public long problem_id { get; set; }
        public Nullable<long> subscriber_id { get; set; }
        public long queue_id { get; set; }
        public Nullable<long> problem_error_code { get; set; }
        public string problem_error_text { get; set; }
